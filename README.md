# University.KhNURE.Web-Т.Practice-3

## What is the project about?

Repository is for educational purpose - doing practical class' [task №3](Практична%20робота%20№3.docx) on the
discipline *"Web technologies and web design"* in
the university "[Kharkiv National University of Radio Electronics][1]".

## What is the purpose of this project?

The **purpose** of the project is ***doing practical task №3*** on the discipline *"Web technologies and web design"*.
...
For running the project you needn't nothing. You can run the [task1.html](html/task1.html) file from your explorer or from IDEA.
...
4. Adds this repository to yours with name `origin` (you can change it, if you want):
    ```
   $ git remote add origin git@github.com:StasonMendelso/git@github.com:StasonMendelso/University.KhNURE.Web-Т.Practice-3.git
   ```
...
Run the project using the [task1.html](html/task1.html) file.
